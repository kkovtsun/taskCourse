...
<body>
<h1 class="h1IndexTitleReg">Please fill in the data fields</h1>
<form action="<c:url value="/registration"/>" method="POST">
    <div class="mainDiv">
        <p class="lbl">Username: <input class="txt1" type="text" name="usernameR"></p>
        <p class="lbl">Password: <input class="txt2"type="password" name="passwordR"></p>

...
<head>
    ...
    <script>
        $("#btn").click(function(){href="${pageContext.request.contextPath}/main"});
        $("#btnR").click(function(){href="${pageContext.request.contextPath}/registration"});
    </script>
</head>
<body>
    <h1 id="h1IndexTitle">Student personnel department</h1>
    <form action="WelcomeServlet" method="post">
        <div id="mainDiv">
            <p class="lbl">Username: <input id="txt1" type="text" name="username"></p>
            <p class="lbl">Password: <input id="txt2"type="password" name="password"></p>
            <p class="lbl">Status:<select id="txt3"name = "status">
                <option value = "user">User</option>
                <option value = "moderator">Moderator</option>
                <option value = "admin">Admin</option>
            </select></p>
            <input id="btn" type="submit" name="logIn" value="Log In" />
            <input id="btnR" type="submit" name="aReg" value="Sign up" />
        </div>
    </form>
